...
PROGS       = afl-gcc afl-as afl-fuzz afl-showmap afl-tmin afl-gotcpu afl-rt.o
...
afl-rt.o: afl-rt.o.c | test_x86
	$(CC) $(CFLAGS) -c $< -o $@

afl-rt-m32.o: afl-rt.o.c | test_x86
	$(CC) $(CFLAGS) -m32 -c $< -o $@

afl-rt-m64.o: afl-rt.o.c | test_x86
	$(CC) $(CFLAGS) -m64 -c $< -o $@
